...
(deftest montecarlo-multiscale
  (is true (let [[x y] (mc simple limits 3 10 1000 5)] (and (< x 0.01) (> x -0.01) (< y 0.01) (> y -0.01))))
  (is true (let [[x y] (mc complex limits 3 10 1000 5)] (and (< x -0.99) (> x -1) (< y -0.47) (> y -0.49)))))
